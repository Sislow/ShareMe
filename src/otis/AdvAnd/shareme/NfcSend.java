...
public class NfcSend extends Activity implements CreateNdefMessageCallback, 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (mNfcAdapter == null) {
				Toast.makeText(this, "NFC not avaliable to this device", Toast.LENGTH_SHORT).show();
			} else {
	...
	private static final String MIME_TYPE = "application/otis.AdvAnd.shareme";
	private static final String PACKAGE_NAME = "otis.AdvAnd.shareme";
